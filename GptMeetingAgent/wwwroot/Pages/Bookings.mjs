...
export default {
  ...
  <div title="Bookings CRUD" class="sm:max-w-fit">
    ...
    <div class="mt-5 flex">
      <SrcLink href="https://github.com/NetCoreTemplates/vue-mjs/blob/main/GptMeetingAgent.ServiceModel/Bookings.cs" />
      <SrcLink href="https://github.com/NetCoreTemplates/vue-mjs/blob/main/GptMeetingAgent/wwwroot/Pages/Bookings.mjs" />
    </div>
  </div>`,
